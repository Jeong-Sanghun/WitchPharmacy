...
public class BossMedicineManager : MonoBehaviour
{
    [SerializeField]
    BossCenterManager bossCenterManager;

    [SerializeField]
    BossCookedMedicineManager bossCookedMedicineManager;
    [SerializeField]
    ...
    public void Update()
    {
        if(bossCenterManager.isGameEnd == true)
        {
            return;
        }
    ...
    {
        if (bossCenterManager.isGameEnd)
        {
            return;
        }
    ...
    void CookFunction()
    {
        ...
        bossCookedMedicineManager.CookedMedicineManagerSetting(cookedMedicine);
        for (int i = 0; i < medicineInPotList.Count; i++)
        {
