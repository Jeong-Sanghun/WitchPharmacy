...
public class TreeterButtonClass
{
    ...
    public void SetTutorialTreeterButton(TreeterData dat, GameObject canvasPrefab, Transform prefabParent, GameObject openedImagePrefab, Transform openedImageParent
    , GameObject mainPostPrefab, GameObject commentPrefab)
    {
        data = dat;
        wholeCanvasObject = GameObject.Instantiate(canvasPrefab, prefabParent);
